...
@pytest.mark.parametrize(
    ...
    [
        ...
        "postgresql+asyncpg://localhost/fitpilot_task_caddy_a1b2c3?host=db.internal",
        "postgresql+asyncpg://localhost/fitpilot_task_caddy_a1b2c3?%68ost=db.internal",
        "postgresql+asyncpg://localhost/fitpilot_task_caddy_a1b2c3?host=localhost&host=db.internal",
        "postgresql+asyncpg://localhost/fitpilot_task_caddy_a1b2c3?database=fitpilot",
        "postgresql+asyncpg://localhost/fitpilot_task_caddy_a1b2c3?port=5433",
        "postgresql+asyncpg://localhost/fitpilot_task_caddy_a1b2c3?user=other",
        "postgresql+asyncpg://localhost/fitpilot_task_caddy_a1b2c3?password=other",
        "postgresql+asyncpg://localhost/fitpilot_task_caddy_a1b2c3?dsn=postgresql://db/fitpilot",
        "postgresql+asyncpg://localhost/fitpilot_task_caddy_a1b2c3?server_settings=x",
        "postgresql+asyncpg://localhost/fitpilot_task_caddy_a1b2c3#host=db.internal",
